...
console.log('started Ssocket.io/index.js Server, srv = ' + JSON.stringify(srv) + ', opts = ' + JSON.stringify(opts));

  if (!(this instanceof Server)) {
    console.log('recursively calling Server since it wasn\'t already created');
